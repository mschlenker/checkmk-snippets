...
from .bakery_api.v1 import (
    ...
    Plugin,
    PluginConfig,
    # SystemBinary, # add when using the commented code parts
    Scriptlet,
    WindowsConfigEntry,
    register,
    FileGenerator,
...
# in the setup GUI and defines in web/plugins/hellobakery_bakery.py.
...
def get_hello_bakery_plugin_files(conf: HelloBakeryConfig) -> FileGenerator:
    ...
    # shell style comments (#), but JSON requires JavaScript like comments (/* ... */).
