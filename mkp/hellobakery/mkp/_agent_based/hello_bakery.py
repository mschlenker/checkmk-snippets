...
#
# This is the Checkmk server side script.

from .agent_based_api.v1 import *

# Most simple discovery function, basically just checks for the agent
...
def check_hello_bakery(params, section):
    for line in section:
        # Proving a metric is the first step to get nice graphs, adding these lines 
        # already allows you to create custom graphs using "hellobakerylevel"
        #
